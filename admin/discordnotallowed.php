...
?>
    ...
    <head>
        ...
        Customlog("ADMIN - DISCORD NOWALLOWED", "error", "Somebody tried to access the admin panel, but has not linked its discord account, or has no access. (If logged in: [Username: $LoggedinUsermail, Rol: $LoggedinUserrole, ID: $LoggedinID])");
    ?>
    </head>
